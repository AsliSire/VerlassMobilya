jQuery(document).ready(function($){
	...
	function animateQuickView(image, finalWidth, maxQuickWidth, animationType) {
        ...
        var parentListItem = image.parent('.cd-item'),
            ...
            quickViewHeight = windowHeight * .9;
            quickViewLeft = (windowWidth - quickViewWidth) / 2;

        // Size quick view pane accoring to window size
        if (windowWidth >= 768 && windowWidth < 1024)
        {
            finalTop = (windowHeight - finalHeight) / 2;
            quickViewLeft = windowWidth / 100 * 4;
            quickViewWidth = windowWidth - (quickViewLeft * 2);
        }
        else if (windowWidth < 768)
        {
            quickViewLeft = windowWidth / 100 * 5;
            finalTop = (windowHeight - quickViewHeight) / 2;
            quickViewWidth = windowWidth - (quickViewLeft * 2);
        }
        else
            finalTop = (windowHeight - finalHeight) / 2;
